...
while True:
    ...
    if estado_jogo == TELA_INICIAL:
        ...
        tela.blit(fonte.render(f"Distância: {score}", True, PRETO), (30, 30))
        tela.blit(fonte.render(f"Pontos: {pontuacao}", True, PRETO), (30, 70))
        tela.blit(fonte.render(f"Velocidade: x{multiplicador_velocidade:.1f}", True, PRETO), (30, 110))
